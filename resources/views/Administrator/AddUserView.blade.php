            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container">
                        ...
                        <form method="post" action="/adduser" class="user">

                        {{ csrf_field() }}
                        <!--Error Message-->
                        <label name="errormessage" class="alert-danger" id="errormessage" style="font-size:15px; font-weight:bold"></label>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Add User</strong> <i class="fa fa-user-plus"></i></h4><br />
                                            </div>
                                            ...
                                            <!--ADD USER FORM-->
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="email" class="form-control" type="text" placeholder="Email" required style="font-size:13px" />
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="password" class="form-control" type="hidden" placeholder="Password" style="font-size:13px" />
                                                                </div>

                                                                <div class="form-group">
                                                                    <input name="dateadded" class="form-control" type="text" placeholder="Date" onfocus="(this.type='date')" required style="font-size:13px" />
                                                                </div>

                                                                <div>
                                                                    <input name="adduser" type="submit" value="ADD USER" class="btn btn-primary btn-block" style="font-size: 13px; font-weight:bold" />
                                                                </div>
                                                            </div>
                                    </div>
                                </div>
