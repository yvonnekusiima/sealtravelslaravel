...
<head>
    ...
    <title>Administrator Activity Log</title>
            ...
            <div class="container-fluid">
                ...
                <form method="post">
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">ADMINISTRATOR ACTIVITY LOG</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            @foreach($administratoractivitylog['data'] as $aal)
