                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Edit User</strong> <i class="fa fa-edit"></i></h4><br />
                                            </div>

                                                            <form method="post" action="/edituser" class="user">
                                                                ...
                                                                <div>
                                                                    <input name="edituser" type="submit" value="SAVE CHANGES" class="btn btn-primary btn-block" style="font-size: 13px; font-weight:bold" />
                                                                </div>
