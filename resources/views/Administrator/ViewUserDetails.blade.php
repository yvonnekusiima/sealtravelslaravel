                ...
                <div class="card-body p-0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-7">
                      <div class="p-5">
                        <div class="">
                          <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>User Details</strong> <i class="fa fa-user"></i></h4><br />
                        </div>
                        <!--USER DETAILS FORM-->
                        @foreach($userdetails as $userdetail)
                        <div class="form-group">
                          <label>Email:</label><b>{{ $userdetail->Email }}</b>
                        </div>
                        <div class="form-group">
                          <label>Username:</label><b>{{ $userdetail->Username }}</b>
                        </div>
                        <div class="form-group">
                          <label>Date Added:</label><b>{{ $userdetail->DateAdded }}</b>
                        </div>
                        @endforeach
                      </div>
                    </div>
