            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form method="post" action="/userlogin" class="user">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <input name="captcha" class="form-control" type="text" placeholder="Enter Captcha Code" style="font-size:13px" />
                            </div>
                            <div>
                                <input name="userlogin" type="submit" value="LOGIN" class="btn btn-primary btn-block" style="font-size: 13px; font-weight:bold" />
                            </div>
                        </form>
