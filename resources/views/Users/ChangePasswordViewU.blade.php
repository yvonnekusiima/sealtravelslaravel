                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="post" action="/changepasswordu" class="user">
                            ...
                            {{ csrf_field() }}
                                ...
                                <div>
                                    <input type="submit" name="changepasswordu" value="SAVE CHANGES" class="btn btn-primary btn-block" style="font-size: 13px; font-weight:bold" />
                                </div>
                            </form>
