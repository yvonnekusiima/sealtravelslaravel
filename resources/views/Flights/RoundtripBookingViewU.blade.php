                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Roundtrip flight</strong> <i class="fa fa-plane"></i></h4><br />
                                            </div>
                                                        <!--Roundtrip Booking Form-->
                                                        <form method="post" action="/roundtripbookingu" class="user">
                                                        ...
                                                        {{ csrf_field() }}
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input name="triptype" class="form-control" value="Roundtrip" style = "font-size: 13px;" />
                                                            </div>
