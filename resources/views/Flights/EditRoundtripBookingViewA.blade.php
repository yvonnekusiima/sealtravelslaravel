...
<head runat="server">
    ...
    <title>Edit Flight Booking - Roundtrip</title>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Edit a Roundtrip booking</strong> <i class="fa fa-edit"></i></h4><br />
                                            </div>
                                                        <!--Roundtrip Booking Form-->
                                                        <form method="post" action="/editroundtripbookinga" class="user">
                                                        ...
                                                        {{ csrf_field() }}
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input name="returning" class="form-control" placeholder="Select" type="datetime-local" style = "font-size: 13px;" />
                                                            </div>
                                                            </div>
                                                            ...
                                                            <!--Book-->
                                                            <div>
                                                                <input name="editroundtripbooking" type="submit" value="SAVE CHANGES" class="btn btn-primary btn-block" style="font-size:13px; font-weight:bold" />
                                                            </div>
