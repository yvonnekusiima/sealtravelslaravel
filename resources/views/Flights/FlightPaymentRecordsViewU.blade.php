                ...
                <form method="post" action="">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">FLIGHT PAYMENTS</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    @foreach($flightpayments['data'] as $flightpayment)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $flightpayment->PaymentMethod }}
                                            </td>
                                            <td>
                                                {{ $flightpayment->CardNumber }}
                                            </td>
                                            <td>
                                                {{ $flightpayment->CVV }}
                                            </td>
                                            <td>
                                                {{ $flightpayment->ExpiryDate }}
                                            </td>
                                            <td>
                                                {{ $flightpayment->Amount }}
                                            </td>
                                            <td style="width:180px">
                                                <a href="{{route('editflightpaymentu')}}" name="edit" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Edit</a>
                                            </td>
                                            <td>
                                                <a href="/deleteflightpaymentu/{{ $flightpayment->Id }}" name="deleteflighpayment" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    @endforeach
