                            ...
                            @foreach($flightpayments['data'] as $flightpayment)
                                ...
                                <tr>
                                    ...
                                    <td style="width:180px">
                                        <a href="{{route('editflightpaymenta')}}" name="edit" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Edit</a>
                                    </td>
                                    <td>
                                        <a href="/deleteflightpaymenta/{{ $flightpayment->Id }}" name="deleteflighpayment" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Delete</a>
                                    </td>
                                </tr>
                                </tbody>
                            @endforeach
