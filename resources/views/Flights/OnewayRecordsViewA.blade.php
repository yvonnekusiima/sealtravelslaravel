                            ...
                            <div class="table-responsive">
                                ...
                                @foreach($flights['data'] as $flight)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('editonewaybookinga')}}" name="edit" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Edit</a>
                                        </td>
                                        <td>
                                            <a href="/deleteonewaybookinga/{{ $flight->Id }}" name="deleteflight" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Delete</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                @endforeach
