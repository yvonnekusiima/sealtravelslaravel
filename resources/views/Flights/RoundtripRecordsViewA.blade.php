                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('editroundtripbookinga')}}" name="edit" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Edit</a>
                                </td>
                                <td>
                                    <a href="/deleteroundtripbookinga/{{ $flight->Id }}" name="deleteflight" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Delete</a>
                                </td>
                            </tr>
                            </tbody>
                        @endforeach
