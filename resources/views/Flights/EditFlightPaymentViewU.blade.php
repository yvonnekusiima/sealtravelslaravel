...
<head runat="server">
    ...
    <title>Edit Flight Payment</title>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        <div class="">
                                            <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Edit Payment Information</strong> <i class="fa fa-edit"></i></h4><br />
                                        </div>

                                        <!--Payment Information Form-->
                                        <form method="post" action="/editflightpaymentu" class="user">
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group">
                                                    <div class="form-check float-left" style="width: 100px; margin-left: 0px; color: #4e73df; font-weight: bold; font-size: 13px">
                                                        <input type="radio" name="paymentmethod" class="" style = "font-size: 13px;" value="Visa Card" /> Visa Card
                                                    </div>
                                                    <div class="form-check float-left" style="width: 160px; color: #4e73df; font-weight: bold; font-size: 13px">
                                                        <input type="radio" name="paymentmethod" class="" style = "font-size: 13px;" value="American Express" /> American Express
                                                    </div>
                                                    <div class="form-check float-left" style="width: 150px; color: #4e73df; font-weight: bold; font-size: 13px">
                                            ...
                                            <!--Submit-->
                                            <div>
                                                <input type="submit" name="editflightpayment" value="SAVE CHANGES" class="btn btn-primary btn-block" style="font-size:13px; font-weight:bold" />
                                            </div>
