...
<head>
    ...
    <title>Oneway Flight Records</title>
                ...
                <form method="post" action="">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">ONEWAY FLIGHTS</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    @foreach($flights['data'] as $flight)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('editonewaybookingu')}}" name="edit" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Edit</a>
                                            </td>
                                            <td>
                                                <a href="/deleteonewaybookingu/{{ $flight->Id }}" name="deleteflight" type="submit" class = "btn btn-primary" style = "width:80px; font-size:13px">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    @endforeach
