                                        ...
                                        <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            @foreach($hotels['data'] as $hotel)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('edithotelbookinga')}}" type="submit" class = "btn btn-primary", style = "width:80px; font-size:13px">Edit</a>
                                                    </td>
                                                    <td>
                                                        <a href="/deletehotelbookinga/{{ $hotel->Id }}" type="submit" class = "btn btn-primary", style = "width:80px; font-size:13px">Delete</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            @endforeach
