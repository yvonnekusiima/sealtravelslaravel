                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('themonarchhotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('mestilhotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('theoberoihotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('kigalimarriotthotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('ekohotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('lagoonhotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('shangri-lahotelu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
                                    ...
                                    <div class="col-md-6 col-lg-3 py-3">
                                        <a href="{{route('hotelbrusselsu')}}" style="text-decoration:none">
                                            <div class="card">
                                                <br />
                                                <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                                <div class="card-body" style="text-align:center;font-weight:bold">
