...
<head runat="server">
    ...
    <title>Kigali Marriott Hotel</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block bg-gradient-primary">
                                <h1 style="font-weight:700; margin-left:100px; margin-top:180px; color:white">Kigali Marriott Hotel</h1>
                            </div>
                            <div class="col-lg-7">
                                <div class="p-5">
                                    <div class="">
                                        <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Hotel</strong> <i class="fa fa-hotel"></i></h4><br />
                                    </div>

                                    <!--Hotel Booking Form-->
                                    <form method="post" action="/hotelbookingu" class="user">
                                        ...
                                        <!--Book-->
                                        <div>
                                            <input name="bookhotel" type="submit" value="BOOK ROOM" class="btn btn-primary btn-block" style="font-size:13px; font-weight:bold" />
                                        </div>
