                ...
                <form method="post" action="">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">HOTEL BOOKINGS</h6>
                        </div>
                        <div class="card-body">
                            ...
                            @foreach($hotels['data'] as $hotel)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('edithotelbookingu')}}" type="submit" class = "btn btn-primary", style = "width:80px; font-size:13px">Edit</a>
                                        </td>
                                        <td>
                                            <a href="/deletehotelbookingu/{{ $hotel->Id }}" type="submit" class = "btn btn-primary", style = "width:80px; font-size:13px">Delete</a>
                                        </td>
                                    </tr>
                                    </tbody>
                            @endforeach
